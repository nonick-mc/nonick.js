...
import { AutoCreateThreadConfig } from '@/lib/database/zod';
...
type InputConfig = z.input<typeof AutoCreateThreadConfig>;
type OutputConfig = z.output<typeof AutoCreateThreadConfig>;
    ...
    <FormCard>
      <FormField
        ...
        render={({ field: { ref, onChange, onBlur, value } }) => (
          <FormItem dir='row'>
            <FormLabel title='自動スレッド作成を有効にする' />
            <FormControl>
      ...
      <FormField
        ...
        render={({ field: { ref, onChange, onBlur, value }, fieldState: { invalid } }) => (
          <FormItem dir='row' mobileDir='col'>
            <FormLabel title='スレッドを作成するチャンネル' isDisabled={disabled} />
            <FormControl>
              <ChannelSelect
                ref={ref}
