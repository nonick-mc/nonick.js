...
export function SettingForm({ channels, setting }: FormProps) {
  const { guildId } = useParams<Awaited<PageProps<'/guilds/[guildId]/auto-public'>['params']>>();
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid} orientation='horizontal'>
                    <FieldContent>
                      <FieldLabel htmlFor={field.name}>自動アナウンス公開を有効にする</FieldLabel>
                    ...
                    render={({ field, fieldState }) => (
                      ...
                      >
                        ...
                        <ChannelSelect
                          ...
                          channels={channels}
                          includeChannelTypes={[ChannelType.GuildAnnouncement]}
                          disabled={!enabled}
                        />
                      </Field>
                    )}
